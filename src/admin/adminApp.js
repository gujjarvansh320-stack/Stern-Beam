...
// import { registerWarranty, serialExists } from '../utils/warrantyApi.js';
...
//       <span class="admin-topbar-brand">STERN BEAM — WARRANTY ADMIN</span>
...
//         <p class="admin-subtitle section-desc" style="margin:0 0 24px;">Enter the customer's details at time of purchase.</p>
...
//   // --- Register (only reachable once signed in — the UI hides this form
//   //     otherwise, and Firestore rules independently require auth to write) ---
...
//       registerForm.reset();
//     } catch (err) {
//       console.error('Warranty registration failed:', err);
...
// import { onAuthStateChanged, signInWithEmailAndPassword, signOut } from 'firebase/auth';
// import { auth } from '../utils/firebase.js';
// import { registerWarranty, serialExists, getAllWarranties, searchWarrantyBySerial } from '../utils/warrantyApi.js';
// import { products } from '../data/products.js';
...
//     <div class="admin-topbar admin-hidden" id="adminTopbar">
//       <span class="admin-topbar-brand">STERN BEAM — WARRANTY ADMIN</span>
//       <div class="admin-topbar-nav" style="display:flex; gap:16px;">
...
//           <input type="text" id="searchInput" placeholder="Search by Serial Number..." style="padding:8px; width:300px; border:1px solid #ccc; border-radius:4px;" />
...
//   const topbar = document.getElementById('adminTopbar');
//   const loginCard = document.getElementById('adminLoginCard');
//   const adminConsole = document.getElementById('adminConsole'); // Register panel
//   const databaseConsole = document.getElementById('databaseConsole'); // Database panel
//   const userEmailEl = document.getElementById('adminUserEmail');
...
//       loadTableData(); // Load all data when switching to DB view
//     }
//   }
...
//     const serialQuery = searchInput.value.trim();
//     if (!serialQuery) return loadTableData();

//     tableBody.innerHTML = '';
//     tableMessage.textContent = "Searching...";
//     try {
//       const data = await searchWarrantyBySerial(serialQuery);
//       renderTable(data);
//     } catch (err) {
...
//   function showPanel(panelName) {
//     // Strip the hidden classes so the panels can be seen
